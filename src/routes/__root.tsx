...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Peras — Branded QR Event Passes in Minutes" },
      ...
      { name: "author", content: "Peras" },
      { property: "og:title", content: "Peras — Branded QR Event Passes in Minutes" },
      ...
      { name: "twitter:title", content: "Peras — Branded QR Event Passes in Minutes" },
